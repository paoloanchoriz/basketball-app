angular.module('myApp', [ 'ngRoute', 'ngResource', 'ui.bootstrap' ]).config(
		function($routeProvider) {
			$routeProvider.when('/venue', {
				templateUrl : 'view/venue/list',
				controller : VenueListController
			}).when('/venue/add', {
				templateUrl : 'view/venue/add',
	...
	var Venue = $resource('/basketball-app/venue/:venueId', {
		venueId : '@id'
	}, {
		'search' : {
			'method' : 'GET'
